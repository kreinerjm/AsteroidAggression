...
public class MinerGame extends Game{
  ...
  Music currentSong;
  Sound alienWarning1 = Gdx.audio.newSound(new FileHandle("sounds/effects/AlienWarning1.mp3"));
  Sound alienWarning2 = Gdx.audio.newSound(new FileHandle("sounds/effects/AlienWarning2.mp3"));
  boolean shouldSpawnEnemies = false;

  public MinerGame(){

    explore = Gdx.audio.newMusic(new FileHandle("sounds/music/Asteroid_Gameplay-Explore-1.mp3"));
    explore.setVolume(.5f);
    fight = Gdx.audio.newMusic(new FileHandle("sounds/music/Asteroid_Gameplay-Fight.mp3"));
    fight.setVolume(.5f);
    backgroundTexture = Gdx.audio.newMusic(new FileHandle("sounds/music/Background Texture.mp3"));
